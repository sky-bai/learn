...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.Version = field.NewInt64(tableName, "version")
	_account.UpdatedByID = field.NewInt64(tableName, "updated_by_id")
	...
	_account.Role = field.NewString(tableName, "role")
	_account.EnterpriseID = field.NewString(tableName, "enterprise_id")
	_account.SubsidiaryID = field.NewInt64(tableName, "subsidiary_id")
	_account.Valid = field.NewBool(tableName, "valid")
	_account.Status = field.NewInt64(tableName, "status")
	_account.ExportDesensitization = field.NewBool(tableName, "export_desensitization")
...
type account struct {
	...
	Valid                 field.Bool   // 是否有效
	Status                field.Int64  // 账号状态，1=有效，2=无效
	ExportDesensitization field.Bool   // 导出数据是否脱敏
...
func (a *account) updateTableName(table string) *account {
	...
	a.UpdatedByID = field.NewInt64(table, "updated_by_id")
	...
	a.EnterpriseID = field.NewString(table, "enterprise_id")
	a.SubsidiaryID = field.NewInt64(table, "subsidiary_id")
	a.Valid = field.NewBool(table, "valid")
	a.Status = field.NewInt64(table, "status")
	a.ExportDesensitization = field.NewBool(table, "export_desensitization")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["updated_by_id"] = a.UpdatedByID
	a.fieldMap["user_name"] = a.UserName
	a.fieldMap["name"] = a.Name
	a.fieldMap["password"] = a.Password
	a.fieldMap["phone"] = a.Phone
	a.fieldMap["role"] = a.Role
	a.fieldMap["enterprise_id"] = a.EnterpriseID
	a.fieldMap["subsidiary_id"] = a.SubsidiaryID
	a.fieldMap["valid"] = a.Valid
	a.fieldMap["status"] = a.Status
	a.fieldMap["export_desensitization"] = a.ExportDesensitization
}
