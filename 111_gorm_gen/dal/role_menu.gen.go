...
func newRoleMenu(db *gorm.DB, opts ...gen.DOOption) roleMenu {
	...
	_roleMenu.Role = field.NewString(tableName, "role")
	_roleMenu.Key = field.NewString(tableName, "key")
	_roleMenu.Label = field.NewString(tableName, "label")
	_roleMenu.Icon = field.NewString(tableName, "icon")
	_roleMenu.Sort = field.NewInt64(tableName, "sort")
	_roleMenu.Path = field.NewString(tableName, "path")
...
type roleMenu struct {
	...
	Key       field.String // 菜单唯一标志
	Label     field.String // 菜单名称label
	Icon      field.String // 菜单icon
	Sort      field.Int64  // 排序
	Path      field.String // 页面路由
